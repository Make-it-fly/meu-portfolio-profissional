...
export default function PageContact(){
  ...
  return (
    <ContentTemplate>
      <StyledPageContact isPortuguese={isPortuguese}>
        ...
        <div className="info-container">
          ...
          {isPortuguese && <a target="_blank" rel="noreferrer" className="button-alternative-green" href="https://api.whatsapp.com/send?phone=5524981017270&text=Ol%C3%A1%20Lucas!%20Vi%20o%20seu%20portfolio."><RiWhatsappFill/>{isPortuguese ? "Mandar um zap" : "WhatsApp"}</a>}
        </div>
      </StyledPageContact>
    </ContentTemplate>
  )
