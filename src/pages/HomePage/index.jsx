		...
		<StyledPageHomePage>
			<div className="container">
				<div className="content">
					<h1>{isPortuguese ? "Olá" : "Hello!"}</h1>
					<h2>
						{isPortuguese
							? "Eu sou Lucas Magalhães"
							: "I am Lucas Magalhães"}
					</h2>
					<p>
						{isPortuguese
							? "Desenvolvedor Full Stack e apaixonado por tecnologia!"
							: "Full Stack Developer and in passion with technology!"}
					</p>
					<ul className="social-media-buttons">
						<li>
							<a
								href={
									"https://www.linkedin.com/in/lucas-magalh%C3%A3es-3b034120a/"
								}
								target="_blank"
								rel="noreferrer">
								<AiFillLinkedin />
						...
						<li>
							<a
								href={"https://github.com/Make-it-fly"}
								target="_blank"
								rel="noreferrer">
								<BsGithub />
							</a>
